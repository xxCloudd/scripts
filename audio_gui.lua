...
addSettingsText()
local testAudiosGUIButton = addSettingsButton('Test Audios', 90)
testAudiosGUIButton.TextColor3 = Color3.fromRGB(95, 120, 95)testAudiosGUIButton.BorderColor3 = Color3.fromRGB(95, 120, 95)
addSettingsText()
local ClearAudioListData = addSettingsButton('Clear Data', 90)
...
testAudiosGUIButton.MouseButton1Click:connect(function()
	(loadstring(game:HttpGet("https://raw.githubusercontent.com/xxCloudd/scripts/main/audiotester.lua"))())(AUDIOS)
end)
